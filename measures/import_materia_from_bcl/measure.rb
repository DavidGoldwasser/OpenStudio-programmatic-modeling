...
# start the measure
class ImportMateriaFromBcl < OpenStudio::Ruleset::ModelUserScript

  # human readable name
  def name
    return "ImportMateriaFromBcl"
  end

  # human readable description
  def description
    return "This is just a proof of concept to show what code is required to directly access BCL from a measure."
  end

  # human readable description of modeling approach
  def modeler_description
    return "This proof of concept gets public content, but eventually need to update to work with private content"
  end
...
ImportMateriaFromBcl.new.registerWithApplication
